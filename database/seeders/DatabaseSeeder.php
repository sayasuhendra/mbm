...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Role::findByName('Panitia')->syncPermissions(['view participants', 'view finances', 'view broadcasts']);
        ...
        $settings = [
            ...
            ['address', 'Komplek Gending Mas, Ujung Berung, Kota Bandung.', 'string', 'contact'],
            ['whatsapp', '628111513335', 'string', 'contact'],
            ['instagram', '@bm_gendingmas', 'string', 'contact'],
            ['google_maps', 'https://share.google/Vbv2M1cXJftqdnDzj', 'url', 'contact'],
