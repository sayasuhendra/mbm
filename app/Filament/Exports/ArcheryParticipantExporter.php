...
class ArcheryParticipantExporter extends BaseExporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('competition_category')->label('Kategori Lomba')->formatStateUsing(fn (?string $state): string => match ($state) {
            ...
            ExportColumn::make('event_name')->label('Kegiatan'),
